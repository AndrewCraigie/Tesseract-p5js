  ...
  switch (plane) {
    case "XY":
      for (let i = 0; i < this.nodes.length; i++) {
        ...
        let r = 1 - (1 - n.unitU * this.unitValue) * this.sideLength;
    ...
    case "XU":
      for (let i = 0; i < this.nodes.length; i++) {
        ...
        let n = this.nodes[i];
        let newX =  n.unitX * cosA + n.unitU * sinA;
        let newU = -(n.unitX * sinA) + n.unitU * cosA;
    ...
    case "YU":
      for (let i = 0; i < this.nodes.length; i++) {
        ...
        let n = this.nodes[i];
        let newY = n.unitY * cosA + n.unitU * -(sinA);
        let newU = n.unitY * sinA + n.unitU * cosA;
    ...
    case "ZU":
      for (let i = 0; i < this.nodes.length; i++) {
        ...
        let n = this.nodes[i];
        let newZ = n.unitZ * cosA + n.unitU * -(sinA);
        let newU = n.unitZ * sinA + n.unitU * cosA;
